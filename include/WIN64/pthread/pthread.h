 ...
 */
PTW32_DLLPORT int PTW32_CDECL pthread_attr_init_win32 (pthread_attr_t * attr);

PTW32_DLLPORT int PTW32_CDECL pthread_attr_destroy_win32 (pthread_attr_t * attr);
...
PTW32_DLLPORT void PTW32_CDECL pthread_exit_win32 (void *value_ptr);
 ...
 */
PTW32_DLLPORT int PTW32_CDECL pthread_cond_init_win32 (pthread_cond_t * cond,
                               const pthread_condattr_t * attr);

PTW32_DLLPORT int PTW32_CDECL pthread_cond_destroy_win32 (pthread_cond_t * cond);

PTW32_DLLPORT int PTW32_CDECL pthread_cond_wait_win32 (pthread_cond_t * cond,
                               pthread_mutex_t * mutex);

PTW32_DLLPORT int PTW32_CDECL pthread_cond_timedwait_win32 (pthread_cond_t * cond,
                                    pthread_mutex_t * mutex,
                                    const struct timespec *abstime);

PTW32_DLLPORT int PTW32_CDECL pthread_cond_signal_win32 (pthread_cond_t * cond);
